...
public class DriveTrain extends SubsystemBase {
    ...
    static CANSparkMax LeftFront = new CANSparkMax(CANPort.kLeftMotorFrontPort, MotorType.kBrushless);
    static CANSparkMax LeftBack = new CANSparkMax(CANPort.kLeftMotorBackPort, MotorType.kBrushless);
    static MotorControllerGroup Left = new MotorControllerGroup(LeftFront, LeftBack);

    // The motors on the right side of the drive.
    static CANSparkMax RightFront = new CANSparkMax(CANPort.kRightMotorFrontPort, MotorType.kBrushless);
    static CANSparkMax RightBack = new CANSparkMax(CANPort.kRightMotorBackPort, MotorType.kBrushless);
