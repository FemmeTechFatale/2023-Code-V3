...
public class AutoJustDrive extends SequentialCommandGroup{ //imagine the beginning of match
    
    DriveSub m_driveSub;
    ArmSub m_ArmSub;
    ClawSub m_ClawSub;
    public AutoJustDrive(DriveSub subsystemOne, ArmSub subsystemTwo, ClawSub subsystemThree) {
